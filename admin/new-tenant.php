    ...
    *******************************************************/
    ...
    ?>
        ...
        <div id="page-wrapper">
                                    ...
                                    <form action="new-tenant.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" min="0" name="phone" class="form-control" id="phone" placeholder="e.g 256 712 345678" required=""> </div>
                                        </div>
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2023 &copy; Kidepo PML Admin </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
