...
<div class="footer">
		<div class="col-md-4 footer-left-agileits">
			<h3>Address</h3>
				<ul>
					<li><span class="glyphicon glyphicon-home" aria-hidden="true"></span>Ambassandor House, Kampala Road - Kampala, Uganda</li>
					...
					<!-- <li><span class="glyphicon glyphicon-earphone" aria-hidden="true"></span> +(256) 704 405 571</li> -->
				</ul>
		</div>
...
<!-- //footer --> 
	<div class="copyright-w3-agile">
		<div class="container">
			<p>© 2023 Kidepo PML | All rights reserved Developed By OH TECHNOLOGIES.</p>
			<div class="clearfix"> </div>
		</div>
	</div>
