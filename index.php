		...
		<div class="container">
			<div class="w3_agile_banner_top">
				<div class="agile_phone_mail">
					<ul>
						<li><i class="fa fa-phone" aria-hidden="true"></i>+(256) 123 456 789</li>
						<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@kidepo.com">info@nyumbanihomes.com</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="wthree_banner_info">
				...
				<section class="slider">
					<div class="flexslider">
						<ul class="slides">
							<li>
								<h3>Welcome to Kidepo Proparty Management</h3>
